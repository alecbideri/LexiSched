        ...
        <div>
            ...
            <div className='my-10 flex flex-col md:flex-row gap-12'>
                ...
                <div className='flex flex-col justify-center gap-6 md:w-2/4 text-sm text-gray-600'>
                    ...
                    <p>Our vision at LexiSched is to create a seamless legal scheduling experience for every user. We aim to bridge the gap between clients and legal professionals, making it easier for you to book and manage legal consultations whenever you need them.</p>
                </div>
            </div>
        ...
        {/*    --- Why choose us ----*/}
            ...
            <div>
                ...
                <div className='flex flex-col md:flex-row mb-20'>
                    ...
                    <div className='border px-10 md:px-16 py-8 sm:py-16 flex flex-col gap-5 text-[15px] hover:bg-primary hover:text-white transition-all duration-300 text-gray-600 border-gray-400'>
                        <b>Convenience:</b>
                        <p>Access to a network of trusted lawyers professionals in your area.</p>
                    </div>
                    <div className='border px-10 md:px-16 py-8 sm:py-16 flex flex-col gap-5 text-[15px] hover:bg-primary hover:text-white transition-all duration-300 text-gray-600 border-gray-400'>
                        <b>Personalization:</b>
                        <p>Tailored recommendations and reminders to help you stay on top of your legal A+ game, ensuring you never miss a crucial consultation or deadline.</p>
                    </div>
                </div>
            </div>
